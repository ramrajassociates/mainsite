    ...
    <div className="flex flex-wrap -m-4">
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <Image className="h-40 rounded w-full object-cover object-center mb-6" src={'https://d1efbx4910ct8i.cloudfront.net/Images2/seo.webp'} alt="Search engine optimization" width={520} height={500}></Image>
         
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Search Engine Optimization</h2>
          <p className="leading-relaxed text-base">Boost your online presence with our SEO expertise. We optimize your website, improve search engine rankings, and drive organic traffic to enhance your digital visibility. Stay ahead in the digital landscape with our proven SEO strategies.</p>
        </div>
      </div>
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <Image className="h-40 rounded w-full object-cover object-center mb-6" src={'https://d1efbx4910ct8i.cloudfront.net/Images2/s-m-o.webp'} alt="social media optimization" width={520} height={500}></Image>
          
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Social Media Optimization</h2>
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <Image className="h-40 rounded w-full object-cover object-center mb-6" src={'https://d1efbx4910ct8i.cloudfront.net/Images2/c-w.webp'} alt="content" width={520} height={500}></Image>
          
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Content Writing </h2>
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <Image className="h-40 rounded w-full object-cover object-center mb-6" src={'https://d1efbx4910ct8i.cloudfront.net/Images2/w-d.webp'} alt="content" width={520} height={500}></Image>
          
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Web Development</h2>
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <Image className="h-40 rounded w-full object-cover object-center mb-6" src={'https://d1efbx4910ct8i.cloudfront.net/Images2/s-e-m.webp'} alt="content" width={520} height={500}></Image>
          
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Search Engine Marketing</h2>
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <Image className="h-40 rounded w-full object-cover object-center mb-6" src={'https://d1efbx4910ct8i.cloudfront.net/Images2/s-m-m.webp'} alt="content" width={520} height={500}></Image>
          
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Social Media Marketing</h2>
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <Image className="h-40 rounded w-full object-cover object-center mb-6" src={'https://d1efbx4910ct8i.cloudfront.net/Images2/p-a-v.webp'} alt="content" width={520} height={500}></Image>
          
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Photo & Videography</h2>
      ...
      <div className="xl:w-1/4 md:w-1/2 p-4">
        <div className="bg-gray-100 p-6 rounded-lg">
          <Image className="h-40 rounded w-full object-cover object-center mb-6" src={'https://d1efbx4910ct8i.cloudfront.net/Images2/g-d.webp'} alt="content" width={520} height={500}></Image>
          
          <h2 className="text-lg text-gray-900 font-medium title-font mb-4">Graphic Design</h2>
