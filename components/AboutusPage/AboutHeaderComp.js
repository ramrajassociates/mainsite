...
<div  className="flex flex-col items-center  md:flex-row gap-5 sm:max-w-full">
    <Image width={1920} height={1080} className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-96 md:rounded-none md:rounded-l-lg" src="https://d1efbx4910ct8i.cloudfront.net/Images2/abt1.webp" alt=""/>
    <div className="flex flex-col justify-between p-4 leading-normal">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">Our Mission</h5>
...
<div  className="flex flex-col items-center  md:flex-row-reverse gap-5 sm:max-w-full  ">
    <Image width={1920} height={1080} className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-96 md:rounded-none md:rounded-l-lg" src="https://d1efbx4910ct8i.cloudfront.net/Images2/abt2.webp" alt=""/>
    <div className="flex flex-col justify-between p-4 leading-normal">
...
<div  className="flex flex-col items-center  md:flex-row gap-5 sm:max-w-full  ">
    <Image width={1920} height={1080} className="object-cover w-full rounded-t-lg h-96 md:h-auto md:w-96 md:rounded-none md:rounded-l-lg" src="https://d1efbx4910ct8i.cloudfront.net/Images2/abt3.webp" alt=""/>
    <div className="flex flex-col justify-between p-4 leading-normal">
        <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white text-center">Our Value</h5>
        <p className="mb-3  text-gray-700 dark:text-gray-400 font-thin  text-xl p-5">
