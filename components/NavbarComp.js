  ...
  return (
    <>
      <div
        className={`w-full ${
          isSticky || position
            ? "sticky bg-gray-700 backdrop-blur bg-opacity-75 [&>*]:text-main"
            : "absolute"
        } top-0 z-[50]  ${
          className
            ? className
            : "hidden sm:grid lg:grid-cols-12 sm:grid-cols-7"
      ...
      >
        ...
        <a
          href={"/"}
          className={`col-span-1 font-thin sm:col-start-3  lg:col-start-7 mx-auto hover:underline hover:underline-offset-8 flex items-center  hover:decoration-action-900 text-${
        ...
        <div
          className={`col-span-1 font-thin cursor-pointer mx-auto hover:underline hover:underline-offset-8 flex items-center  hover:decoration-action-900  text-${
            textColor ? textColor : "main"
          } group  `}
        >
          Services
...
hover:decoration-action-900"
                    ...
                    <li>
                      ...
                      <Link
                        href={
                          "/digital-marketing-services/social-media-optimization"
                        }
                        className="block px-4 py-2 text-main cursor-pointer hover:underline hover:underline-offset-8
hover:decoration-action-900"
                      >
...
hover:decoration-action-900"
                  ...
                  <ul className="list-disc pl-6">
                    <li>
                      ...
                      <Link
                        href={
                          "/web-design-and-development/custom-web-development"
                        }
                        className="block px-4 py-2 text-main cursor-pointer hover:underline hover:underline-offset-8
hover:decoration-action-900"
                      >
...
hover:decoration-action-900"
      ...
      {/* Mobile Menu */}
      <div
        className={`h-[7vh] grid sm:hidden grid-cols-12 w-full ${
          isSticky || position
            ? "fixed bg-gray-700 backdrop-blur bg-opacity-75 [&>*]:text-main"
            : "absolute"
        } top-0 z-[100]  `}
      >
        ...
        <div className=" col-span-2 col-start-11">
          <FiMenu
            ...
            size={25}
            onClick={() => setCloseMenu((e) => !e)}
          ></FiMenu>
        </div>
        <div
          className={`  ${
            !CloseMenu ? "translate-x-[32rem]" : "translate-x-0"
          } transition-all duration-700  flex flex-col fixed right-0 space-y-5 h-[100vh] overflow-y-auto w-[70vw] top-0 justify-start items-start [&>*]: pl-5 [&>*]:!text-lg  p-1 bg-black `}
          id="MobileMenu"
        >
          <IoCloseOutline
          ...
          <a
            href={"/"}
            className={` border-b border-action-900 w-full  pb-4  font-thin text-center !mt-36 flex items-center  hover:decoration-action-900 text-${
              textColor ? textColor : "main"
            }   `}
          >
            <span>Home</span>
          ...
          <Link
            href={"/about"}
            className={` border-b border-action-900 w-full  pb-4  font-thin  text-center flex items-center  hover:decoration-action-900 text-${
              textColor ? textColor : "main"
            }   `}
          >
            <span>About Us</span>
          ...
          <div
            className={`  border-b border-action-900 w-full  pb-4 font-thin cursor-pointer text-center flex items-center  hover:decoration-action-900  text-${
              textColor ? textColor : "main"
            } group  `}
