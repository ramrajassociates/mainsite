  ...
  if (SlideNavbarComp) {
    ...
    return (
      ...
      >
        ...
        <div className="content flex flex-col  gap-5 items-start  lg:px-24 px-5 ">
    ...
    return (
      <div
        className={`lg:px-10 px-5 flex  flex-col lg:min-h-[100vh] bg-gray-200 gap-5 items-start lg:pt-20 pt-5 overflow-y-scroll ${className}`}
        id="FaqsSection"
        ref={FaqsSectionCompRef}
      >
