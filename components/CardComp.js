...
function CardComp(props) {
  ...
  return (
      <div className={`md:w-48 h-48 bg-white  relative shadow-sm shadow-gray-400 flex flex-col duration-500 transition-all justify-center items-center text-action cursor-pointer group z-10 -mt-24 overflow-hidden ${className}`}>
          <div className='bg-action absolute top-0 w-full h-full -z-10 -translate-x-96 group-hover:translate-x-0 duration-500 ' ></div>
