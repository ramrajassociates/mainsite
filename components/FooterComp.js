  ...
  return (
    <div className='flex md:flex-row flex-col  w-full md:h-[70vh] bg-gray-900 md:px-24 px-5 py-10  justify-around '>
      ...
      <div className='flex flex-col space-y-4 pt-10 md:w-1/3 w-full'>
        <h1 className='text-2xl text-action-900 text-start font-semibold '> <span className='underline underline-offset-8'>Off</span>icial Info :</h1>
        <p className=' font-bold text-main text-start pt-10'>Open Hours :</p>
        <ul className='[&>*]:text-sm font-semibold space-y-2 [&>*]:text-gray-400  '>
         
          <li><Link href={'https://goo.gl/maps/S7MhVqZj68racWKYA'}>  <FaLocationDot className='text-action-900 mr-2 inline-block'></FaLocationDot> 32, Shastri Nagar, Jaipur, Rajasthan, India </Link></li>
          <li><Link href={'tel:+919414001803'}> <IoCall className='text-action-900 mr-2 inline-block'></IoCall> +91 94140 01803 </Link></li>
          <li><Link href={'tel:+919116145123'}> <IoCall className='text-action-900 mr-2 inline-block'></IoCall> +91 91161 45123 </Link></li>

        </ul>
        <p className='text-start text-gray-400 text-sm font-semibold'>Mon - Sat: 10 AM - 7 PM <br />
Sunday: Closed</p>
          </div>
      <div className='flex flex-col space-y-4 pt-10  md:w-1/3 w-full'>  <h1 className='text-2xl text-action-900 text-start font-semibold '> <span className='underline underline-offset-8'>Ga</span>llery</h1>
