...
<div  class="relative w-full sm:h-[100vh] h-[50vh]  overflow-hidden " data-carousel="slide">
    <div class="relative overflow-hidden h-full ">
        <div class="hidden duration-700 ease-in-out relative" data-carousel-item>
            <Image src={'/images/tele.jpg'} width={1920} height={1080} alt='image...' className='brightness-50'  ></Image>
...
Consultancy</p>
        ...
        <div class="hidden duration-700 ease-in-out relative" data-carousel-item>
            <Image src={'/images/digi.jpg'} width={1920} height={1080} alt='image...' className='brightness-50'  ></Image>
            <div className='absolute top-0 w-full h-full z-30 md:p-48 '>
...
peripherals solutions</p>
        ...
        <div class="hidden duration-700 ease-in-out relative" data-carousel-item>
            <Image src={'/images/web.jpg'} width={1920} height={1080} alt='image...' className='brightness-50'  ></Image>
            <div className='absolute top-0 w-full h-full z-30 md:p-48 '>
...
Consultancy</p>
    ...
    <div class="absolute z-30 flex space-x-3 flex-row  overflow-y-hidden overflow-x-hidden  bottom-0 justify-center pb-2 w-full bg-black pt-10 px-10">
          ...
          <div  class="sm:w-48 sm:h-24 hidden w-32 h-24 group cursor-pointer object-contain relative hover:-translate-y-3 transition-all duration-500" aria-current="true" aria-label="Slide 2" data-carousel-slide-to="1">
            <Image src={'uparrow.svg'} width={50} height={100} className='absolute w-full brightness-50 group-hover:-translate-y-3 hidden group-hover:block'></Image>
