...
<div  className="relative w-full sm:h-[100vh] h-[30vh] " data-carousel="slide">
    <div className="relative overflow-hidden h-full ">
        <div className="hidden duration-700 ease-in-out relative" data-carousel-item>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/tele.jpg'} width={1920} height={1080} alt='image...' className='absolute block w-full -translate-x-1/2  top-1/2 left-1/2 brightness-50'  ></Image>
...
Consultancy</p>
        ...
        <div className="hidden duration-700 ease-in-out relative" data-carousel-item>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/digi.jpg'} width={1920} height={1080} alt='image...' className='absolute block w-full -translate-x-1/2  top-1/2 left-1/2 brightness-50'  ></Image>
            <div className='absolute top-0 w-full h-full z-30 md:p-48 '>
...
expertise in Digital Marketing</p>
        ...
        <div className="hidden duration-700 ease-in-out relative" data-carousel-item>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/cp.jpg'} width={1920} height={1080} alt='image...' className='absolute block w-full -translate-x-1/2  top-1/2 left-1/2 brightness-50'  ></Image>
            <div className='absolute top-0 w-full h-full z-30 md:p-48 '>
...
peripherals solutions</p>
        ...
        <div className="hidden duration-700 ease-in-out relative" data-carousel-item>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/web.jpg'} width={1920} height={1080} alt='image...' className='absolute block w-full -translate-x-1/2  top-1/2 left-1/2 brightness-50'  ></Image>
            <div className='absolute top-0 w-full h-full z-30 md:p-48 '>
...
development services</p>
        ...
        <div className="hidden duration-700 ease-in-out relative" data-carousel-item>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/business.jpg'} width={1920} height={1080} alt='image...' className='absolute block w-full -translate-x-1/2  top-1/2 left-1/2 brightness-50'  ></Image>
            <div className='absolute top-0 w-full h-full z-30 md:p-48 '>
...
Consultancy</p>
        ...
        <div className="hidden duration-700 ease-in-out relative" data-carousel-item>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/sur.jpg'} width={1920} height={1080} alt='image...' className='absolute block w-full -translate-x-1/2  top-1/2 left-1/2 brightness-50'  ></Image>
            <div className='absolute top-0 w-full h-full z-30 md:p-48 '>
...
Consultancy</p>
    ...
    <div className="absolute z-30 h-24 sm:h-auto sm:flex hidden space-x-3 flex-row overflow-x-scroll  overflow-y-hidden sm:overflow-hidden  bottom-0 justify-center pb-2 w-fit sm:w-full bg-gray-600 bg-opacity-40 sm:pt-10 pt-5 px-10">
          <div  className="sm:w-48 sm:h-24 w-48 h-20  group cursor-pointer object-contain relative hover:-translate-y-3 transition-all duration-500" aria-current="true" aria-label="Slide 1" data-carousel-slide-to="0">
            ...
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/tele.jpg'} width={1920} height={1080} className='h-full w-full group-hover:brightness-50' alt='image...' ></Image> 
          ...
          <div  className="sm:w-48 sm:h-24  w-48 h-20 group cursor-pointer object-contain relative hover:-translate-y-3 transition-all duration-500" aria-current="true" aria-label="Slide 2" data-carousel-slide-to="1">
            <Image src={'uparrow.svg'} width={50} height={100} className='absolute w-full brightness-50 group-hover:-translate-y-3 hidden group-hover:block'></Image>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/digi.jpg'} width={1920} height={1080} className='h-full w-full group-hover:brightness-50' alt='image...' ></Image> 
          ...
          <div  className="sm:w-48 sm:h-24 w-48 h-20 group cursor-pointer object-contain relative hover:-translate-y-3 transition-all duration-500" aria-current="true" aria-label="Slide 3" data-carousel-slide-to="2">
            <Image src={'uparrow.svg'} width={50} height={100} className='absolute w-full brightness-50 group-hover:-translate-y-3 hidden group-hover:block'></Image>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/cp.jpg'} width={1920} height={1080} className='h-full w-full group-hover:brightness-50' alt='image...' ></Image> 
          ...
          <div  className="sm:w-48 sm:h-24 w-48 h-20 group cursor-pointer object-contain relative hover:-translate-y-3 transition-all duration-500" aria-current="true" aria-label="Slide 4" data-carousel-slide-to="3">
            <Image src={'uparrow.svg'} width={50} height={100} className='absolute w-full brightness-50 group-hover:-translate-y-3 hidden group-hover:block'></Image>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/web.jpg'} width={1920} height={1080} className='h-full w-full group-hover:brightness-50' alt='image...' ></Image> 
          ...
          <div  className="sm:w-48 sm:h-24 w-48 h-20 group cursor-pointer object-contain relative hover:-translate-y-3 transition-all duration-500" aria-current="true" aria-label="Slide 5" data-carousel-slide-to="4">
            <Image src={'uparrow.svg'} width={50} height={100} className='absolute w-full brightness-50 group-hover:-translate-y-3 hidden group-hover:block'></Image>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/business.jpg'} width={1920} height={1080} className='h-full w-full group-hover:brightness-50' alt='image...' ></Image> 
          ...
          <div  className="sm:w-48 sm:h-24 w-48 h-20 group cursor-pointer object-contain relative hover:-translate-y-3 transition-all duration-500" aria-current="true" aria-label="Slide 5" data-carousel-slide-to="5">
            <Image src={'uparrow.svg'} width={50} height={100} className='absolute w-full brightness-50 group-hover:-translate-y-3 hidden group-hover:block'></Image>
            <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images/sur.jpg'} width={1920} height={1080} className='h-full w-full group-hover:brightness-50' alt='image...' ></Image> 
