...
function AboutComp(props) {
  ...
  <div className="max-w-screen-xl px-4 py-4 mx-auto text-center lg:py-16 lg:px-6">
      <figure className="max-w-screen-md mx-auto">
          ...
          <blockquote>
              <p className="text-md font-thin text-gray-200">"Ordered my first IT brand building project like mobile app & web
...
professionally. "</p>
          ...
          <figcaption className="flex items-center justify-center mt-6 space-x-3">
              ...
              <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                  <div className="pr-3 font-medium text-gray-200 ">Sailesh Shukla</div>
                  <div className="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Business Head</div>
              </div>
          </figcaption>
      </figure>
  </div>
  ...
  <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
      <figure className="max-w-screen-md mx-auto">
          ...
          <blockquote>
              <p className="text-md font-thin text-gray-200">"I am running my social media campaigns through Ramraj Associates, I
am getting good outcomes for my social campaigns"</p>
          </blockquote>
          <figcaption className="flex items-center justify-center mt-6 space-x-3">
              {/* <Image className="w-6 h-6 rounded-full" src={"https://d1efbx4910ct8i.cloudfront.net/Images2/abt1.webp"} width={50} height={50} alt="profile picture"></Image> */}
              <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                  <div className="pr-3 font-medium text-gray-200 ">Kuldeep Singh</div>
                  <div className="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Jan Sewak</div>
              </div>
          </figcaption>
      </figure>
  </div>
  ...
  <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
      <figure className="max-w-screen-md mx-auto">
          ...
          <blockquote>
              <p className="text-md font-thin text-gray-200">"We assigned them Rajasthan government project and their team work
...
handwork, now we are getting desired outcomes"</p>
          ...
          <figcaption className="flex items-center justify-center mt-6 space-x-3">
              {/* <Image className="w-6 h-6 rounded-full" src={"https://d1efbx4910ct8i.cloudfront.net/Images2/abt1.webp"} width={50} height={50} alt="profile picture"></Image> */}
              <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                  <div className="pr-3 font-medium text-gray-200 ">Himanshu Sharma</div>
                  <div className="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Project Head</div>
              </div>
          </figcaption>
      </figure>
  </div>
  ...
  <div className="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
      <figure className="max-w-screen-md mx-auto">
          ...
          <blockquote>
              <p className="text-md font-thin text-gray-200">"They are handling my online brand image nicely and generating
business for us by creating awareness about yoga and its benefits."</p>
          </blockquote>
          <figcaption className="flex items-center justify-center mt-6 space-x-3">
              {/* <Image className="w-6 h-6 rounded-full" src={"https://d1efbx4910ct8i.cloudfront.net/Images2/abt1.webp"} width={50} height={50} alt="profile picture"></Image> */}
              <div className="flex items-center divide-x-2 divide-gray-500 dark:divide-gray-700">
                  <div className="pr-3 font-medium text-gray-200 ">Dhakaram (Yogapeace)</div>
                  <div className="pl-3 text-sm font-light text-gray-500 dark:text-gray-400">Yogacharya</div>
              </div>
          </figcaption>
      </figure>
  </div>
  ...
  <div className="mx-auto flex flex-row items-center flex-wrap space-y-3 sm:space-y-0 [&>*]:py-1 text-center w-full h-full">
      ...
      <div className="sm:w-1/4 w-full border border-gray-200 rounded-lg sm:rounded-none sm:border-none p-2  ">
        <div className=" h-full text-center">
          ...
          <h2 className="title-font font-medium sm;text-md  md:text-xl text-gray-900">105+</h2>
      ...
      <div className="sm:w-1/4 w-full border border-gray-200 rounded-lg sm:rounded-none sm:border-none p-2  ">
        <div className=" h-full text-center">
          ...
          <h2 className="title-font font-medium sm;text-md  md:text-xl text-gray-900">15+</h2>
      ...
      <div className="sm:w-1/4 w-full border border-gray-200 rounded-lg sm:rounded-none sm:border-none p-2  ">
        ...
        {/* <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images2/project.webp'} width={50} height={50} className='mx-auto'></Image> */}
          ...
          <h2 className="title-font font-medium sm;text-md  md:text-xl text-gray-900">10k+</h2>
      ...
      <div className="sm:w-1/4 w-full border border-gray-200 rounded-lg sm:rounded-none sm:border-none p-2  ">
        ...
        {/* <Image src={'https://d1efbx4910ct8i.cloudfront.net/Images2/reviews.webp'} width={50} height={50} className='mx-auto'></Image> */}
          ...
          <h2 className="title-font font-medium sm;text-md  md:text-xl text-gray-900">850+</h2>
