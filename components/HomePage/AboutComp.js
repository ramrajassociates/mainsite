    ...
    return (<>
      <div className={`${className} flex md:flex-row flex-col md:px-24 md:space-x-32 justify-center items-center w-full py-10`} ref={Currentref}>
          <div className='relative p-10 md:w-1/2 flex flex-row justify-center '>
             ...
             <FaPlay className='absolute text-5xl text-main bg-action rounded-full p-4 hover:shadow-md hover:shadow-gray-300 transition-all duration-200 cursor-pointer animate-pulse bottom-10 right-5 md:bottom-24 md:right-24'></FaPlay>
          </div>
...
Experienced</span>
                  ...
                  <div className='flex flex-row justify-center items-center'>
            <TbReportAnalytics className='text-3xl text-action -ml-3 md:-ml-0' size={100}></TbReportAnalytics>
