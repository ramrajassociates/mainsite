...
<div class="w-11/12 mx-auto py-5 sm:w-full bg-white border border-gray-200 relative  shadow-xl dark:bg-gray-800 dark:border-gray-700 sm:col-start-2 sm:col-span-2 sm:row-span-1 row-start-3 ">
  ...
  <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
      <figure class="max-w-screen-md mx-auto">
          ...
          <blockquote>
              <p class="text-xl font-thin text-gray-900 dark:text-white">"Ordered my first IT brand building project like mobile app & web
...
professionally. "</p>
  ...
  <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
      <figure class="max-w-screen-md mx-auto">
          ...
          <blockquote>
              <p class="text-xl font-thin text-gray-900 dark:text-white">"I am running my social media campaigns through Ramraj Associates, I
am getting good outcomes for my social campaigns"</p>
  ...
  <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
      <figure class="max-w-screen-md mx-auto">
          ...
          <blockquote>
              <p class="text-xl font-thin text-gray-900 dark:text-white">"We assigned them Rajasthan government project and their team work
...
handwork, now we are getting desired outcomes"</p>
  ...
  <div class="max-w-screen-xl px-4 py-8 mx-auto text-center lg:py-16 lg:px-6">
      <figure class="max-w-screen-md mx-auto">
          ...
          <blockquote>
              <p class="text-xl font-thin text-gray-900 dark:text-white">"They are handling my online brand image nicely and generating
